...
export const toggleIsFetchig = (isFetchig) => ({type: TOGGLE_IS_FETCHING, isFetchig})
export const toggleFollowingProgress = (isFetchig, userId) => ({type: TOGGLE_IS_FOLLOWING_PROGRES, isFetchig, userId})

export const getUsers = (currentPage,pageSize) => {
	 return (dispatch) => {
		dispatch(toggleIsFetchig(true));
